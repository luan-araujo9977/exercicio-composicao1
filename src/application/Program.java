...
public class Program {
	...
	public static void main(String[] args) throws ParseException {
		...
		//recortando uma string e convertendo para int;
		...
		System.out.println();
		System.out.print("Want to remove any contract(s/n)? ");
		char resp = sc.next().charAt(0);
		if (resp == 's') {
			System.out.println("Enter the data of the contract you want to remove");
			System.out.print("Date (DD/MM/YYYY): ");
			Date data = sdf.parse(sc.next());
			HourContract contract = new HourContract(data);
			worker.removeContract(contract);
			
			System.out.println();
			System.out.println("Updated list of contracts: ");
